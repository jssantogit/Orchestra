...
export function inspectProjectEvidence(targetDir) {
  ...
  const statePath = join(root, ".codex", "orchestra-state", "active-state.json");
  const contractPath = join(root, ".codex", "orchestra-state", "active-contract.json");
...
export function formatEvidenceInspection(report) {
  if (!report.available) {
    return [
      "Orchestra Codex Evidence Status",
  ...
  const lines = [];
  lines.push("==================================================");
  lines.push(" Orchestra Codex Evidence Status");
  lines.push("==================================================");
